 ...
 */
public class NumbersOne extends GameState {
    ...
    public NumbersOne(final GameStateManager gsm) {
        super(gsm);



        one = new Texture("1080/cutscene/NumbersOne/4.jpg");
        two = new Texture("1080/cutscene/NumbersOne/5.jpg");
        three = new Texture("1080/cutscene/NumbersOne/6.jpg");
        ...
        cutSceneButtons.continueBtn.addListener(new ClickListener(){
            ...
            public boolean touchDown(InputEvent e, float x, float y, int pointer, int button){
                ...
                if (counter >= 3){
                    ...
                    gameData.putInteger(current + " from", 23);
                    gameData.flush();
